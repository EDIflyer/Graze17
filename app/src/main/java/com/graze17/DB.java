...
import com.graze17.search.SearchProvider;
import com.graze17.util.SQLiteOpenHelper;
...
public class DB extends SQLiteOpenHelper
{
  ...
  public Cursor findByFullText(String query)
  {
     ...
     * SearchManager.SUGGEST_COLUMN_TEXT_2 + ", atom_id AS " + SearchManager.SUGGEST_COLUMN_INTENT_DATA + ", \"com.graze17.VIEW\" AS " +
